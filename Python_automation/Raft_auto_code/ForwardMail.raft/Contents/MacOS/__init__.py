...
def runTest(params):
    ...
    if "Success" in Forward_mail_result:
        logNote("\nReport : Outlookclient - Forward_mail_result : pass")
    else:
        logNote("\nReport : Outlookclient - Forward_mail_result: fail")
